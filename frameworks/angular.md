...
Based on the Angular roadmap and community signals:
- **Selectorless components** — define components without a `selector`; use directly in templates
- **Stable Signal Forms** — graduation from developer preview
- **OnPush as default** for new components generated by Angular CLI
- **TypeScript 5.9 support**
- **Angular MCP Server enhancements**
- **Zone.js removal roadmap** — further progress toward fully zoneless change detection
